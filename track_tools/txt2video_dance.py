...
def txt2img(visual_path="visual_val_gt",exp_name=''):
    ...
    img_path = 'dance/train/'
    show_video_names = ['dancetrack0001']

    test_json_path = 'dance/annotations/test.json'
    test_img_path = 'dance/test/'
    test_show_video_names = ['14']
    ...
    for show_video_name in show_video_names:
        ...
        if visual_path == "visual_val_gt":
            txt_path = 'dance/train/' + show_video_name + '/gt/gt_val_half.txt'
        elif visual_path == "visual_val_predict_dance":
...
if __name__ == '__main__':
    visual_path="visual_val_predict_dance"
    if len(sys.argv) > 1:
        visual_path =sys.argv[1]
    exp_name = 'output_dance/exp2_exp50'
    txt2img(visual_path,exp_name)

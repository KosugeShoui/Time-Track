...
def plot_combined_loss(exp_name):
    ...
    train_loss_ce_list = [entry['train_loss_ce'] for entry in data]
    ...
    # 保存して表示
    plt.savefig(os.path.join(exp_name, 'combined_loss.png'))
    plt.show()
...
if __name__ == "__main__":
    ...
    plot_combined_loss(args.exp_name)
